const myGalleryImages = ["1.jpg", "2.jpg", "Art_4.jpg", "Art_5.jpg", "Art_6.jpg", "Art_7.jpg", "Art_8.jpg", "Art_9.jpg", "Art_10.jpg"];
...
function selectPage(clickedElement, pageName) {
    ...
    if (pageName === 'Home Content') {
        const latestGalleryImg = myGalleryImages[myGalleryImages.length - 1];
        contentArea.innerHTML = `
            <div class="home-container">
                <section class="hero-block">
                    <h1>VETOVOX</h1>
                    <p>Here I am working on a game, a book, and a comic.</p>
                </section>
                <div class="news-main-wrapper">
                    <div class="news-column">
                        <h3>Devlog</h3>
                        <div class="news-card text-card" onclick="selectPage(null, 'Devlog Content')">
                            <div class="news-card-content"><p>NEW</p></div>
                        </div>
                    </div>
                    <div class="news-column">
                        <h3>Game</h3>
                    ...
                    <div class="news-column">
                        ...
                        <div class="news-card gallery-preview" onclick="selectPage(null, 'Gallery Content')">
                            ...
                            <div class="news-card-content"><h3>Последний арт</h3></div>
                        </div>
                    </div>
                </div>
            </div>`;
        ...
        myGalleryImages.forEach(imgSrc => {
            galleryHTML += `<img src="${imgSrc}" alt="Арт" onclick="openImage('${imgSrc}')">`;
        });
        galleryHTML += `</div>`;
        contentArea.innerHTML = galleryHTML;
        ...
        contentArea.innerHTML = `
            <div class="about-container">
                ...
                <div class="about-art"><img src="Art_3.jpg" alt="Мой арт"></div>
            </div>`;
    } else if (pageName === 'Contact Content') {
        contentArea.innerHTML = `
            <div class="about-container">
                <div class="about-text" style="width: 100%;">
                    <p class="about-text-custom">For business inquiries, please reach out via email:</p>
                    <div style="display: flex; align-items: center; gap: 15px; margin-top: 10px;">
                        <span class="email-link">allerti065@gmail.com</span>
                        <div class="copy-icon" onclick="copyEmail()"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg></div>
                    </div>
                </div>
                <div class="about-art"><img src="Art_3.jpg" alt="Contact Art"></div>
            </div>`;
    }
}

function copyEmail() {
    navigator.clipboard.writeText("allerti065@gmail.com").then(() => {
...
function createBtn(text, position) {
    ...
    btn.innerHTML = text;
    btn.style.cssText = `position:absolute; ${position}; top:50%; transform:translateY(-50%); color:white; font-size:60px; font-weight:bold; padding:20px; cursor:pointer; z-index:10000;`;
    return btn;
}
...
window.onload = function() {
    ...
    if (lastPage) {
        ...
        selectPage(document.querySelector('.menu a'), 'Home Content');
    }
};